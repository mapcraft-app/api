...
export default [
	...
	{
		id: 'frost_walker',
		description: 'Freezes water into ice so that you can walk on it and also allows you to walk on magma blocks without taking damage',
		level: [ 1,
			2 ]
	},
	{
	...
	{
		id: 'soul_speed',
		description: 'Speeds up how fast you can move across soul sand and soul soil',
		level: [ 1,
			3 ]
	},
	{
	...
	{
		id: 'swift_sneak',
		description: 'Allows the player to walk more quickly while sneaking',
		level: [ 1,
			5 ]
	}
] as enchantement[];
